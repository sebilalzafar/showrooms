    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('showroom_type', models.CharField(choices=[('Lights', 'Lights'), ('Tiles', 'Tiles'), ('Art and Culture', 'Art and Culture'), ('Cars', 'Cars'), ('Sanitary', 'Sanitary'), ('Sanitary Ware', 'Sanitary Ware'), ('Chip Board', 'Chip Board'), ('PVC Piping', 'PVC Piping'), ('Marble Stone', 'Marble Stone')], default='', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imported_or_local', models.CharField(choices=[('Imported', 'Imported'), ('Local', 'Local')], max_length=50)),
                ('old_price', models.IntegerField()),
                ('new_price', models.IntegerField()),
                ('discount_price', models.CharField(blank=True, default='example:20% Off', max_length=50, null=True)),
                ('description', models.TextField()),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.categories')),
                ('company_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.company_name')),
            ],
        ),
        migrations.CreateModel(
            name='Lights',
        ...
        migrations.AddField(
            model_name='product',
            name='showroom',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.showrooms'),
        ),
        migrations.CreateModel(
            name='Callback',
            fields=[
                ...
                ('showroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.showrooms')),
            ],
        ),
    ]
